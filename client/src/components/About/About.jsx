import storyImg from "../../assets/img/aboutImg.png";
import missionImg from "../../assets/img/aboutImg2.png";
  ...
  return (
    <div className={styles.aboutContainer}>
      ...
      <div className={styles.sections} style={{marginBottom: "2px"}}>
        ...
        <Figure.Image  width={450} src={storyImg} />
      </div>
      <div className={styles.sections}>
        <Figure.Image width={371} src={missionImg} />
        <div className={styles.text}>
